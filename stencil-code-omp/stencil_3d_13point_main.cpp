// 3D 13-point Stencil 主函数 - OpenMP 版本
...
#ifdef RUN_MAIN
int main() {
    std::cout << "3D 13-point OpenMP 版本测试" << std::endl;
    ...
    stencil3D_13point_omp(g1, g2, DEPTH, ROWS, COLS, 1);
    ...
    stencil3D_13point_omp(g1, g2, DEPTH, ROWS, COLS, 2);
