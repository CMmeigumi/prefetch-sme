...
void stencil2D_9point_omp(double* __restrict__ grid, double* __restrict__ new_grid,
                            int rows, int cols, int stride);
void stencil3D_13point_omp(double* __restrict__ grid, double* __restrict__ new_grid,
...
double test_stencil_1d_3point(bool run_stride1, bool run_stride2) {
    ...
    if (run_stride1) {
        ...
        for (int iter = 0; iter < 1000; iter++) stencil1D_3point_omp(g1, g2, SIZE, 1);
    ...
    if (run_stride2) {
        ...
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 1000; iter++) stencil1D_3point_omp(g1, g2, SIZE, 2);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
...
double test_stencil_2d_5point(bool run_stride1, bool run_stride2) {
    ...
    if (run_stride1) {
        ...
        std::cout << "stride=1..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil2D_5point_omp(g1, g2, ROWS, COLS, 1);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
    ...
    if (run_stride2) {
        ...
        std::cout << "stride=2..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil2D_5point_omp(g1, g2, ROWS, COLS, 2);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
...
double test_stencil_2d_9point(bool run_stride1, bool run_stride2) {
    ...
    if (run_stride1) {
        ...
        std::cout << "stride=1..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil2D_9point_omp(g1, g2, ROWS, COLS, 1);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
    ...
    if (run_stride2) {
        ...
        std::cout << "stride=2..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil2D_9point_omp(g1, g2, ROWS, COLS, 2);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
...
double test_stencil_3d_13point(bool run_stride1, bool run_stride2) {
    ...
    if (run_stride1) {
        ...
        std::cout << "stride=1..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil3D_13point_omp(g1, g2, DEPTH, ROWS, COLS, 1);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
    ...
    if (run_stride2) {
        ...
        std::cout << "stride=2..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil3D_13point_omp(g1, g2, DEPTH, ROWS, COLS, 2);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
...
double test_stencil_3d_25point(bool run_stride1, bool run_stride2) {
    ...
    if (run_stride1) {
        ...
        std::cout << "stride=1..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil3D_25point_omp(g1, g2, DEPTH, ROWS, COLS, 1);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
    ...
    if (run_stride2) {
        ...
        std::cout << "stride=2..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil3D_25point_omp(g1, g2, DEPTH, ROWS, COLS, 2);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
...
double test_stencil_3d_27point(bool run_stride1, bool run_stride2) {
    ...
    if (run_stride1) {
        ...
        std::cout << "stride=1..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil3D_27point_omp(g1, g2, DEPTH, ROWS, COLS, 1);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
    ...
    if (run_stride2) {
        ...
        std::cout << "stride=2..." << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        for (int iter = 0; iter < 100; iter++) stencil3D_27point_omp(g1, g2, DEPTH, ROWS, COLS, 2);
        auto end = std::chrono::high_resolution_clock::now();
        elapsed = std::chrono::duration<double>(end - start).count();
        std::cout << "Time: " << elapsed << " s" << std::endl;
        total_time += elapsed;
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "=== Stencil Scalar OMP Tests ===" << std::endl;
