 ...
 *
 * This version excludes all prefetch instructions for comparison testing.
 */
...
#include "attention/flash_mla/flash_fwd_mla_kernel/kernels/mla_bf16_32x64_nopf.h"
...
{
    printf("FlashMLA BF16 32x64 Kernel Test (NO PREFETCH)\n");
    printf("==============================================\n\n");
