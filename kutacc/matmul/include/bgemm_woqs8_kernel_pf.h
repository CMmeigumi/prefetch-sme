...
static void bgemm_woqs8_kernel_16_pf(int64_t m, int64_t n, int64_t k, const int8_t *a,
    ...
    __bf16 _beta, const float *scale) __arm_streaming
{
    ...
    if (block_size == 16) {
        bgemm_woqs8_kernel_16_pf<RowQuant>(m, n, k, a, lda, b, ldb, c, ldc, _alpha, _beta, scale);
        return;
    }
