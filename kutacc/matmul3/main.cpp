...
int main(int argc, char **argv)
{
    ...
    for (int i = 1; i < argc; i++) {
        if (strcmp(argv[i], "-h") == 0 || strcmp(argv[i], "--help") == 0) {
            ...
            printf("Kernel: bgemm_kernel (4VL_1VL, 1VL_1VL, no prefetch)\n");
            return 0;
    ...
    printf("BGEMM Kernel Test (No Prefetch, from kutacc-br_dist_infer)\n");
    ...
    for (int repeat = 0; repeat < repeat_count; repeat++) {
        ...
        kutacc::bgemm_kernel(m, n, n, k, A, B, C);
    }
